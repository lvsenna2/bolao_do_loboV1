...
export default function HomePage() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-app-background text-app-foreground">
      ...
      />
      <main className="relative mx-auto flex w-full max-w-7xl flex-1 items-center px-4 py-8 sm:px-6 sm:py-14 lg:px-8">
        <section className="grid w-full items-center gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(320px,460px)] lg:gap-16">
          <div className="order-1 mx-auto max-w-2xl space-y-6 text-center lg:mx-0 lg:text-left">
          ...
          <div className="home-logo-stage order-2 mx-auto flex w-full max-w-[180px] items-center justify-center sm:max-w-[280px] lg:max-w-[460px]">
            <Image
              alt="Logo do Bolão do Lobo"
              className="home-logo-float h-auto w-full object-contain"
              height={512}
              priority
              sizes="(max-width: 639px) 180px, (max-width: 1023px) 280px, 460px"
